    ...
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">All rights reserved
          <a style="color:#20a0ff" href="https://dangdang.com" target="_blank">当当网</a>
        </div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">请联系店铺管理员，用主账号开通相关权限。</div>
        <router-link to="/" class="bullshit__return-home">回主页</router-link>
      </div>
    </div>
  </div>
</template>
